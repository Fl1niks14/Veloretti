			...
			<section>
				<article>
					...
					<article>
						<div className="peple-content">
							...
							<div className="text-peple">
								...
								<h2>Veloretti Electrics benefit both the environment and the health of
					...
					<div className="text-peple">
								...
								<h2>The bike plan is totally independent of the WKR and is free for you as
...
employer, decide whether you want to contribute to the costs.
					...
					<article>
						...
						<p>Fill in our registration form with your company details. After <br />
					...
					<h2>Determine the requirements</h2>
						<p className="none">You get acces to the digital platform. Set the requirements for <br />
						your employees and share the registration link.
						</p>
						<h2>Ride your bike!</h2>
						<p>Let's go! Your employees can choose their bikes and they'll be <br />
						delivered straight to their homes.
						</p>
						<h2>Administration</h2>
						<p className="none">Everything in one place. The digital platform gives you an easy <br />
